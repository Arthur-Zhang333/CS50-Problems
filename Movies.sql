...
#Finally, each query should return only the data necessary to answer the question: if the problem only asks you to output the names of movies, 
#for example, then your query should not also output the each movie’s release year.
